...
def handle_player_turn_keys(key):
    ...
    # Movement keys
    if (key.vk == libtcod.KEY_UP or key_char == 'k' or
            key.vk == libtcod.KEY_KP8):
        return {'move': (0, -1)}
    elif (key.vk == libtcod.KEY_DOWN or key_char == 'j' or
          key.vk == libtcod.KEY_KP2):
        return {'move': (0, 1)}
    elif (key.vk == libtcod.KEY_LEFT or key_char == 'h' or
          key.vk == libtcod.KEY_KP4):
        return {'move': (-1, 0)}
    elif (key.vk == libtcod.KEY_RIGHT or key_char == 'l' or
